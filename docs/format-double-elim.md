...
* Utilize bracket software!
  * It may be tempting to draw your own double-elim bracket for a smaller event, but at *least* check it against one generated by bracket software. No one wants to be 'that person' who drew up a bracket with double jeopardy (early rematch) in a high-profile event.
