...
Once you are in the last three rounds of either side bracket, those rounds are usually then named "Upper/Lower Quarterfinal", "Upper/Lower Semifinal", and "Upper/Lower Final".
